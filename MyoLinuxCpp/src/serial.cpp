...
namespace MYOLINUX_NAMESPACE {
     ...
     * In case of permission denied exception try running the program with sudo, if that fixes the problem
     * you are not the member of uucp group.
     * Run sudo usermod -a -G uucp <user> to add an user.
